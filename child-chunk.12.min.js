(window.webpackJsonp=window.webpackJsonp||[]).push([[12],{976:function(e,t,l){"use strict";window.xbrz_process_function_string=`return async function(image_data, scale) {
  ...
  }`;const r=(t,l,o,s=null)=>{s?s.exec(new Function(window.xbrz_process_function_string)(),[t,l]).catch(e=>"Pool terminated"!==e?Promise.resolve(new Function(window.xbrz_process_function_string)()(t,l)):void r(t,l,o,s)).then(e=>{o(e)}).timeout(6e4):new Function(window.xbrz_process_function_string)()(t,l).then(e=>{o(e)})};e.exports={xbrz:r}}}]);