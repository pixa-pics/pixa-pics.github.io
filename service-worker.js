"use strict";
var REQUIRED_CACHE = "unless-update-cache-v874-required";
var USEFUL_CACHE = "unless-update-cache-v874-useful";
var STATIC_CACHE = "unless-update-cache-v874-static";
...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(35).map(F_CNK));
