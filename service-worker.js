...
// Cache names
var REQUIRED_CACHE = "unless-update-cache-v1044-required";
var USEFUL_CACHE = "unless-update-cache-v1044-useful";
var STATIC_CACHE = "unless-update-cache-v1044-static";
var OTHER_CACHE = "unless-update-cache-v1044-other";
...
self.addEventListener("fetch", function(event) {
    ...
    const same_site = event.request.referrer.startsWith(U.hostname);
