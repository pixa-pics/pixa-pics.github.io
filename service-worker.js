...
// Cache names
var REQUIRED_CACHE = "unless-update-cache-v922-required";
var USEFUL_CACHE = "unless-update-cache-v922-useful";
var STATIC_CACHE = "unless-update-cache-v922-static";
var OTHER_CACHE = "unless-update-cache-v922-other";
    ...
    if (event.request.headers.get('range')) {
        ...
        event.respondWith(
            Promise.any([
                ...
                other_cache.then(function (cache) {
                ...
                fetch(request).then(function (response) { // Fetch and serve
                    return other_cache.then(function (cache) {
                        if (response.status === 200) {
