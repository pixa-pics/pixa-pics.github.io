"use strict";
var REQUIRED_CACHE = "unless-update-cache-v869-required";
var USEFUL_CACHE = "unless-update-cache-v869-useful";
var STATIC_CACHE = "unless-update-cache-v869-static";
...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(34).map(F_CNK));
