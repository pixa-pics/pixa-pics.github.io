"use strict";
var REQUIRED_CACHE = "unless-update-cache-v848-required";
var USEFUL_CACHE = "unless-update-cache-v848-useful";
var STATIC_CACHE = "unless-update-cache-v848-static";
...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(32).map(F_CNK));
