...
var LOAD_FILES_REQUIRED = [].concat(new Array(47).map(F_CNK));
...
// Cache names
var REQUIRED_CACHE = "unless-update-cache-v1046-required";
var USEFUL_CACHE = "unless-update-cache-v1046-useful";
var STATIC_CACHE = "unless-update-cache-v1046-static";
var OTHER_CACHE = "unless-update-cache-v1046-other";
