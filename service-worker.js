"use strict";
var REQUIRED_CACHE = "unless-update-cache-v789-required";
var USEFUL_CACHE = "unless-update-cache-v789-useful";
var STATIC_CACHE = "unless-update-cache-v789-static";
...
var INSTALL_FILES_REQUIRED = ["/client/chunk_main_690b702c.min.js", "/client/chunk_main_748942c6.min.js", "/client/chunk_norris.min.js", "/"];
var INSTALL_FILES_USEFUL = ["/src/images/favicon.ico", "/src/images/manifest/logo-white.png", "/src/fonts/jura/index.css"];
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(31).map(F_CNK));
var LOAD_FILES_USEFUL = ["/src/fonts/baksheesh/index.css"].concat(["illusion.jpg", "gallery/Ban.png", "gallery/Ban.svg", "gallery/sco.png", "gallery/Sco.svg", "gallery/Bud.png", "gallery/Bud.svg", "gallery/Cop.png", "gallery/Cop.svg", "demo/Beast.jpg", "demo/PortraitB.jpg", "demo/Cartoon.jpg", "demo/Illustration.jpg", "infographics/Rambo.svg", "infographics/TestBag.svg", "infographics/Explosion.svg", "labostration/ABDUCTION.svg", "labostration/CHEMISTRY.svg", "labostration/COMPUTING.svg", "labostration/DOWNLOAD.svg", "labostration/GENOMA.svg", "labostration/MOLECULE.svg", "labostration/NUCLEAR.svg", "labostration/SCIENCE.svg", "REMINDER.svg", "Error.svg", "laboratory.svg", "illustrations/Camo.svg", "league/Bronze.png", "league/Diamond.png", "league/Gold.png", "league/Silver.png"].map(F_IMG));
