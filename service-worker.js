"use strict";
var REQUIRED_CACHE = "unless-update-cache-v851-required";
var USEFUL_CACHE = "unless-update-cache-v851-useful";
var STATIC_CACHE = "unless-update-cache-v851-static";
...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(33).map(F_CNK));
