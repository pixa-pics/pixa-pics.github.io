"use strict";
var REQUIRED_CACHE = "unless-update-cache-v854-required";
var USEFUL_CACHE = "unless-update-cache-v854-useful";
var STATIC_CACHE = "unless-update-cache-v854-static";
...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(36).map(F_CNK));
