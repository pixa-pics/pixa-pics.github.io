var REQUIRED_CACHE = "unless-update-cache-v16-required";
var USEFUL_CACHE = "unless-update-cache-v16-useful";
var STATIC_CACHE = "unless-update-cache-v16-static";
            ...
            caches.open(REQUIRED_CACHE).then(function (cache) {
                return cache.match("/father-chunk.norris.min.js").then(function (response) {
                    return (
                        response ||
                        fetch(event.request).then(function (response) { // Fetch, clone, and serve
                            cache.put("/father-chunk.norris.min.js", response.clone());
                            return response;
                        })
                    );
                });
