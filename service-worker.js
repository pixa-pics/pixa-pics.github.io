...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(44).map(F_CNK));
...
// Cache names
var REQUIRED_CACHE = "unless-update-cache-v962-required";
var USEFUL_CACHE = "unless-update-cache-v962-useful";
var STATIC_CACHE = "unless-update-cache-v962-static";
var OTHER_CACHE = "unless-update-cache-v962-other";
