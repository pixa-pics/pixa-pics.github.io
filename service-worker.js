"use strict";
var REQUIRED_CACHE = "unless-update-cache-v887-required";
var USEFUL_CACHE = "unless-update-cache-v887-useful";
var STATIC_CACHE = "unless-update-cache-v887-static";
...
var LOAD_FILES_REQUIRED = ["/"].concat(new Array(38).map(F_CNK));
