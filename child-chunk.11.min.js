(window.webpackJsonp=window.webpackJsonp||[]).push([[11],{971:function(i,t,e){"use strict";window.rgb_quant_process_function_string=`return async function(img, limit, resize_to, lossly) {
...
//		l = Math.floor(l * 100)
    ...
    }`,i.exports={rgb_quant:(t,e=1024,r=2073600,a=!1,s=()=>{},n=null)=>{var i=function*(){var i;Boolean(n)?(i=yield n.exec(new Function(window.rgb_quant_process_function_string)(),[t,e,r,a]).catch(function(i){return Promise.resolve(new Function(window.rgb_quant_process_function_string)()(t,e,r,a))}).timeout(6e4),s(i)):(i=yield new Function(window.rgb_quant_process_function_string)()(t,e,r,a),s(i))};(function(){var o=i.apply(this,arguments);new Promise(function(s,n){return function t(i,e){try{var r=o[i](e),a=r.value}catch(i){return void n(i)}if(!r.done)return Promise.resolve(a).then(function(i){t("next",i)},function(i){t("throw",i)});s(a)}("next")})})()}}}}]);