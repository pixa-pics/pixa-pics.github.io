        ...
        return (
            <div>
                <List key={language} style={{paddingTop: 0}} className={classes.labList}>
                    <ListItem style={{borderBottom: "2px solid #5461ff"}} button onClick={this._open_pixel_page}>
