...
Object.defineProperty(SuperCanvas.prototype, 'render', {
    get: function() { "use strict"; return function () {
        ...
        if (typeof b2 !== "undefined" && this.state_.enable_paint_type === "bitmap") {
            ...
            this.state_.s.canvas_context.putImageData(new ImageData(new Uint8ClampedArray(this.state_.pr_uint8a.buffer), this.state_.s.width|0, this.state_.s.height|0), 0, 0);
            return Promise.resolve();
        }
    }}
});
    ...
    get: function() { "use strict"; return function () {
        ...
        if (this.state_.enable_paint_type === "bitmap") {
            ...
            return new Promise((resolve, reject) => {
                createImageBitmap(new ImageData(new Uint8ClampedArray(this.state_.pr_uint8a.buffer), this.state_.s.width|0, this.state_.s.height|0)).then((bitmap) => {
            ...
            this.state_.s.offscreen_canvas_context.putImageData(new ImageData(new Uint8ClampedArray(this.state_.pr_uint8a.buffer), this.state_.s.width|0, this.state_.s.height|0), 0, 0);
            return Promise.resolve();
        }else {
            return Promise.resolve();
        }
