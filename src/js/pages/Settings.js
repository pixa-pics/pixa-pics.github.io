                ...
                <Container maxWidth="sm" className={classes.container}>
                    ...
                    <Fade in timeout={225*2}>
                        <Card style={{position: "relative", zIndex: 1, minHeight: "500px",
                            ...
                            <div style={{backgroundImage: "url(/src/images/infographics/BlueHorse.svg)", backgroundSize: "contain", backgroundPosition:"center", backgroundRepeat: "no-repeat", padding: 0, margin: 0, position: "absolute", width: "100%", height: "100%", filter: "contrast(1.5) opacity(0.33)", zIndex: "-1"}}></div>
                            <CardHeader style={{textAlign: "center"}} title={
                                <span>
                                    ...
                                    <span style={{fontWeight: "bold"}}>GREAT SUPPORTERS!</span>
                                    <BlingBling className="emoji-150" style={{verticalAlign: "middle", transformOrigin: "right", transform: "translate(50%, 0px) scale(2)"}} />
                                </span>
                            }/>
                            <CardContent>
                            ...
                            <CardContent>
                                <h2><img src={"/src/images/league/Diamond.svg"} style={{verticalAlign: "middle", height: "2em"}}/> ∞) Diamond Supporters <sup style={{fontSize: "0.5em"}}>(Businesses that involve our own)</sup></h2>
                                <p>Coming soon!</p>
                            </CardContent>
                            <Divider/>
                            <CardContent>
                                ...
                                <p>All those friends greatly help us to move only forward faster. Thank you all.</p>
                            </CardContent>
                        </Card>
                    </Fade>
