...
const styles = theme => ({
    ...
    settingButton: {
        ...
        transition: "transform 1440ms linear 0ms",
        "&:hover": {
                                    ...
                                    return (<Fade in={true} timeout={600+index*300} key={index}>
                                                ...
                                                <div className={classes.mediaOverlay}>
                                                    <div className={classes.votes}>
                                                        <IconButton><AutorenewSharpIcon/></IconButton>
                                                        <IconButton><KeyboardArrowUpOutlined/></IconButton>
                                                        <IconButton><KeyboardArrowDownOutlined/></IconButton>
                                                    </div>
                                                    <IconButton className={img.favorite? classes.favoriteTrue: classes.favoriteFalse} onClick={ () => {this.toggleFavoriteAtIndex(index)}}>{img.favorite ? <FavoriteOutlined/>: <FavoriteBorder/>}</IconButton>
                                                    <span className={classes.mediaTitle}>
                                                        <span className={classes.mediaTitleAuthor}>@sophia.julio</span>
                                                        <span className={classes.mediaTitleName}>{img.name}</span>
                                                    </span>
                                                    <span className={classes.mediaMoney}>
