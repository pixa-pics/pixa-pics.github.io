            ...
            <div className={classes.root}>
                ...
                <div className={classes.headerContainer} style={{color: THEME_DAY && !IS_EVENING? "#000": "#fff", contentVisibility: "auto"}}>
                    ...
                    <h2 className={classes.titleh2} style={{color: THEME_DAY && !IS_EVENING ? "#000": "#fff"}}>
                        <span><span className={classes.bold}>Apply effects in laboratory? Yes?</span> Essential lab operations gives the <span className={classes.bold}><span className={classes.revelantText} style={{color: THEME_DAY && !IS_EVENING ? "#100d4e": "#008eff"}}>MAXIMA of PRIVACY</span></span> in a fashion not only looking great for the <span className={classes.bold}>ONLINE SELF-IMAGE</span>...</span>
                    </h2>
                    <h2 className={classes.titleh2} style={{color: THEME_DAY && !IS_EVENING ? "#000": "#fff"}}>
                        <span><span className={classes.stepPoints} style={{color: THEME_DAY && !IS_EVENING ? "#100d4e": "#008eff"}}>2 >></span> <JacketEmojiSvg alt="scientist-jacket-tweemoji" className="emoji-150"/> <span className={classes.bold}><span className={classes.revelantText} style={{color: THEME_DAY && !IS_EVENING ? "#100d4e": "#008eff"}}> WHILE DRAWING/EDITING</span></span> a <span className={classes.bold}>MINIMA-ART</span>, you can use <span className={classes.bold}>55+ tools in 7 panels for pixel art</span>, options in layers, filters, selections, shapes, effects,... to process it with LAB-OPS!</span>
                    </h2>
                    <h2 className={classes.titleh2} style={{color: THEME_DAY && !IS_EVENING ? "#000": "#fff"}}>
