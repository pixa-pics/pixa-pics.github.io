...
function SvgEmojiU1F4691F3Ff(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      ...
      <path
        ...
        fill="url(#emoji_u1f469_1f3ff_svg__a)"
      />
      <path
        ...
        fill="#33251f"
      />
      <ellipse cx={42.9} cy={75.23} rx={6.32} ry={6.55} fill="#1a1717" />
      <ellipse cx={85.1} cy={75.23} rx={6.32} ry={6.55} fill="#1a1717" />
      <path
        d="M52.29 63.47c-1.2-1.59-3.99-3.91-9.39-3.91s-8.19 2.32-9.39 3.91c-.53.71-.4 1.52-.03 2.01.34.46 1.35.88 2.47.5s3.3-1.51 6.95-1.53c3.65.03 5.84 1.15 6.95 1.53 1.12.38 2.13-.04 2.47-.5.37-.49.5-1.3-.03-2.01zm42.21 0c-1.2-1.59-3.99-3.91-9.39-3.91s-8.19 2.32-9.39 3.91c-.53.71-.4 1.52-.03 2.01.34.46 1.35.88 2.47.5s3.3-1.51 6.95-1.53c3.65.03 5.84 1.15 6.95 1.53 1.12.38 2.13-.04 2.47-.5.36-.49.5-1.3-.03-2.01zM74.8 97.66c-4.09 2.43-17.49 2.43-21.58 0-2.35-1.4-4.75.74-3.77 2.87.96 2.1 8.27 6.96 14.59 6.96s13.54-4.86 14.5-6.96c.98-2.14-1.39-4.27-3.74-2.87z"
        fill="#1a1717"
      />
      <radialGradient
        id="emoji_u1f469_1f3ff_svg__b"
        cx={64.001}
        cy={51.437}
        r={61.833}
      ...
      <path
        ...
        fill="url(#emoji_u1f469_1f3ff_svg__b)"
      />
    </svg>
  );
}

export default SvgEmojiU1F4691F3Ff;
