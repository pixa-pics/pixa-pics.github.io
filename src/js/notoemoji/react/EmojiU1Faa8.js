...
function SvgEmojiU1Faa8(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <linearGradient
        id="emoji_u1faa8_svg__a"
      ...
      <path
        d="M8.93 90.74c-.53-1.25-1.04-2.5-1.54-3.75-3.77-9.51.96-18.09 5.18-26.49l6.12-12.16c1.23-2.45 3.12-4.51 5.44-5.95l17.6-10.92 17.39-17.98a8.147 8.147 0 013.97-2.27l11.84-2.86c5.73-1.37 8.19-1.15 10.04 1.48 6.41 9.1 10.7 16.59 16.41 25.66 3.11 4.94 10.29 16.29 10.74 17.04 1.38 2.32.82 4.26.77 6.92-.12 6.13.96 12.29 3.2 18 .67 1.7 1.44 3.38 1.79 5.17.32 1.61-.11 11.84-.44 15.3-.27 2.81-6.91 13.3-9.29 14.57-2.62 1.4-22.04 8.54-26.33 9.76s-22.89-3.03-32.55-4.51c-5.97-.91-11.95-1.83-17.92-2.74-5.18-.79-10.33-.19-13.23-5.42-3.41-6.12-6.47-12.41-9.19-18.85z"
        fill="url(#emoji_u1faa8_svg__a)"
      />
      <linearGradient
        id="emoji_u1faa8_svg__b"
        gradientUnits="userSpaceOnUse"
        x1={8.859}
        y1={120.137}
        x2={47.171}
      ...
      <path
        ...
        fill="url(#emoji_u1faa8_svg__c)"
      />
      <linearGradient
        id="emoji_u1faa8_svg__d"
        gradientUnits="userSpaceOnUse"
        x1={37.502}
        y1={104.545}
        x2={47.502}
      ...
      <path
        ...
        fill="url(#emoji_u1faa8_svg__d)"
      />
      <linearGradient
        id="emoji_u1faa8_svg__e"
        gradientUnits="userSpaceOnUse"
        x1={41.732}
        y1={20.416}
        x2={70.782}
      ...
      <path
        d="M67.16 20.74c-1.28-1.53-1.64-3.7-1.2-5.64.37-1.62 3.73-4.75 4.82-5.74l-7.69 1.86a8.226 8.226 0 00-3.97 2.27L41.73 31.47s16.84-7.02 25.43-10.73z"
        fill="url(#emoji_u1faa8_svg__e)"
      />
      <linearGradient
        id="emoji_u1faa8_svg__f"
        gradientUnits="userSpaceOnUse"
        x1={87.261}
        y1={76.607}
        x2={121.616}
      ...
      <path
        d="M116.08 77.46a46.38 46.38 0 01-3.06-13.39c-5.74 3.93-8.95 9.03-18.19 10.28-2.45.33-6.24.79-8.63 1.42-2.96.78-5.7 2.97-10.14 3.38-3.16.3-11.13.07-9.93 1.85 1.2 1.78 8.35 5.37 10.13 6.82 2.53 2.03 4.73 4.42 6.84 6.88 1.1 1.29 2.75 4.42 4.67 5.27.49.22 1.01.28 1.53.12.91-.27 1.64-.93 2.35-1.56a94.403 94.403 0 0122.97-15.02c.89-.41 1.85-.87 2.29-1.75.19-.39.27-.92.28-1.49-.35-.94-.74-1.87-1.11-2.81z"
        fill="url(#emoji_u1faa8_svg__f)"
      />
      <linearGradient
        id="emoji_u1faa8_svg__g"
        gradientUnits="userSpaceOnUse"
        x1={104.646}
        y1={123.357}
        x2={97.606}
      ...
      <path
        ...
        fill="url(#emoji_u1faa8_svg__g)"
      />
    </svg>
  );
}

export default SvgEmojiU1Faa8;
