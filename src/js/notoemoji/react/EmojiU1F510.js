  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      ...
      <linearGradient
        ...
        y2={84.429}
      >
        <stop offset={0} stopColor="#9e740b" />
        <stop offset={0.306} stopColor="#9e740b" stopOpacity={0.963} />
      </linearGradient>
      <path
        ...
        fill="url(#emoji_u1f510_svg__a)"
      />
      <path d="M6.57 63.43h79.29" fill="#e2a610" />
      <path
        d="M54.11 108.24l-4.49-10.58a7.662 7.662 0 004.33-6.9c0-4.24-3.44-7.67-7.67-7.67s-7.67 3.44-7.67 7.67c0 2.85 1.56 5.34 3.87 6.66l-4.18 10.89c-.53 1.38.49 2.85 1.96 2.85h11.92c1.5 0 2.52-1.54 1.93-2.92z"
        fill="#4e342e"
      />
      <path
        d="M53.69 107.26H38.7l-.4 1.05c-.53 1.38.49 2.85 1.96 2.85h11.92c1.51 0 2.52-1.54 1.93-2.92l-.42-.98zM43.16 95.4c.18-.52-.01-1.08-.45-1.4-.6-.44-1.41-1.22-1.92-2.46-1.86-4.48.35-6.47.35-6.47a7.622 7.622 0 00-2.54 5.69c0 2.85 1.56 5.34 3.87 6.66l.69-2.02zm8.51-10.1s2.2 4.42-.32 7.25c-.86.96-1.59 1.47-2.13 1.72-.53.25-.77.88-.52 1.41l.93 1.96a7.662 7.662 0 004.33-6.9c-.01-3.25-2.29-5.44-2.29-5.44z"
        fill="#9e740b"
      />
      <path
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.156} stopColor="#3d8192" />
        <stop offset={0.277} stopColor="#3d8192" />
      </radialGradient>
      <path
