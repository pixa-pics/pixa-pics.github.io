...
function SvgEmojiU1F914(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u1f914_svg__a"
        cx={63.6}
        cy={1104.9}
        r={56.96}
      ...
      <path
        ...
        fill="url(#emoji_u1f914_svg__a)"
      />
      <linearGradient
        id="emoji_u1f914_svg__b"
        gradientUnits="userSpaceOnUse"
        x1={63.6}
        y1={1160.8}
        x2={63.6}
      ...
      />
      <path
        d="M76.87 71.31c-.32-.06-.62-.19-.87-.4a32.924 32.924 0 00-15.6-6.86c-5.71-.99-11.57-.45-17 1.56-.3.12-.62.16-.94.11-.7-.12-1.27-.64-1.46-1.33-.19-.68.04-1.4.58-1.85 10.6-8.8 26.32-7.34 35.12 3.26.72.87 1.38 1.79 1.98 2.74.38.59.38 1.35 0 1.94-.39.61-1.1.93-1.81.83zm3.9-40.2c4.19 0 8 3.54 8 9.42s-3.81 9.41-8 9.41c-4.19 0-8-3.54-8-9.41s3.81-9.42 8-9.42zM46.14 22c-4.19 0-8 3.54-8 9.41s3.81 9.42 8 9.42c4.2 0 8-3.54 8-9.42s-3.8-9.41-8-9.41zm-6.41-11.37c-.45-.74-.51-1.66-.16-2.45.38-.79 1.13-1.33 2-1.44 5.45-.85 11.01.44 15.53 3.59 1.69 1.16 3.19 2.56 4.46 4.17.08.1.15.21.22.33.68 1.06.45 2.46-.53 3.25a2.75 2.75 0 01-3.6-.08l.42-.68-.51.6A25.46 25.46 0 0042 12c-.95 0-1.83-.5-2.31-1.32l.04-.05zM93 28.52a2.65 2.65 0 001.34-2 2.59 2.59 0 00-1-2.24c-4.33-3.45-9.83-5.1-15.34-4.58-2.04.17-4.04.65-5.94 1.42l-.36.17c-1.11.59-1.6 1.92-1.14 3.09a2.743 2.743 0 003.15 1.7v-.8l.14.78c5.6-1.04 11.39-.17 16.44 2.47.83.47 1.84.47 2.67 0l.04-.01z"
        fill="#422b0d"
      />
      <path
        d="M45.96 25.15c-1.03-.72-2.58-.49-3.58.95-1 1.45-.67 2.97.36 3.69 1.03.72 2.58.49 3.58-.95 1-1.45.67-2.97-.36-3.69zm34.61 8.56c-1.03-.72-2.58-.49-3.58.95-1 1.45-.67 2.97.36 3.69 1.03.72 2.58.49 3.58-.95 1.01-1.45.68-2.97-.36-3.69z"
        fill="#896024"
      />
    </svg>
  );
