...
function SvgEmojiU2651(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <circle cx={64} cy={64} r={60} fill="#5e35b1" />
      <circle cx={60.1} cy={63.1} r={56.1} fill="#7e57c2" />
      <path
        d="M94.8 84.1c-1.6.8-3.4 1.6-6.5 1.6-2 0-4.6-.4-8.1-1.3-.4-.1-.6-.4-.6-.8-.1-8 1.8-12.1 3.6-14.2 1.8-2 3.4-3.1 6.5-3.1h.3c3 0 5.3 1.3 7.5 4 5.5 6.5-.4 12.7-2.7 13.8z"
        opacity={0.2}
        fill="#5e35b1"
      />
      <path
