...
function SvgEmojiU1F610(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u1f610_svg__a"
        cx={63.6}
        cy={2584.9}
        r={56.96}
      ...
      />
      <path
        d="M89 88H39c-2.21 0-4-1.79-4-4s1.79-4 4-4h50c2.21 0 4 1.79 4 4s-1.79 4-4 4zM44.67 45.94c-4.19 0-8 3.54-8 9.42s3.81 9.41 8 9.41c4.19 0 8-3.54 8-9.41s-3.81-9.42-8-9.42z"
        fill="#422b0d"
      />
      <path
        d="M44.28 49.87a2.874 2.874 0 00-3.82 1.34c-.53 1.11-.29 2.44.6 3.3 1.42.68 3.13.08 3.82-1.34.53-1.11.29-2.44-.6-3.3z"
        fill="#896024"
      />
      <path
      ...
      />
      <path
        d="M82.63 49.87a2.874 2.874 0 00-3.82 1.34c-.53 1.11-.29 2.44.6 3.3 1.42.68 3.13.08 3.82-1.34.53-1.11.29-2.44-.6-3.3z"
        fill="#896024"
      />
    </svg>
  );
