...
function SvgEmojiU2611(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="M38.8 105.5a8.862 8.862 0 01-8.7-6.2L15 53.8c-1.46-4.81 1.26-9.9 6.07-11.36 4.65-1.41 9.59 1.08 11.23 5.66l9.8 29.5L89.2 18c3.12-3.95 8.85-4.62 12.8-1.5s4.62 8.85 1.5 12.8L45.9 102a9.086 9.086 0 01-7.1 3.5z"
        fill="#fbf9f9"
      />
    </svg>
  );
