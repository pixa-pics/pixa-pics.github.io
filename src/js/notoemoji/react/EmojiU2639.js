...
function SvgEmojiU2639(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u2639_svg__a"
        cx={63.6}
        cy={1400.9}
        r={56.96}
      ...
      />
      <path
        d="M34.37 96.74C40.77 85.63 54.25 81.06 64 81.06s23.23 4.57 29.63 15.68c.9 1.58 3.47.89 3.18-.91-2.46-15-19-23.45-32.81-24-14.6-.53-29.93 9.84-32.81 24-.35 1.77 2.28 2.49 3.18.91zM44 40.94c-4.19 0-8 3.54-8 9.42s3.81 9.41 8 9.41c4.2 0 8-3.54 8-9.41s-3.76-9.42-8-9.42z"
        fill="#422b0d"
      />
      <path
