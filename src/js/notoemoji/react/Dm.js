      ...
      <g fill="#006b3f" transform="translate(600 300)">
        ...
        <g id="DM_svg__b">
          <path
            id="DM_svg__a"
            stroke="#000"
            d="M-4.81-118.41L0-132.13l4.37 13.5 14.65.22-11.59 8.85 5.25 15.05L0-103.8l-12.46 8.85 4.81-14.61-11.37-8.63 14.21-.22z"
          />
          <use xlinkHref="#DM_svg__a" transform="rotate(180)" />
        </g>
        <use xlinkHref="#DM_svg__b" transform="rotate(36)" />
        <use xlinkHref="#DM_svg__b" transform="rotate(72)" />
        <use xlinkHref="#DM_svg__b" transform="rotate(108)" />
        <use xlinkHref="#DM_svg__b" transform="rotate(144)" />
        <g stroke="#000" strokeWidth={2.5}>
          ...
          <path
            fill="#9461c9"
            strokeWidth={0.575}
            d="M-14.734-52.686s-14.655 12.72-13.01 47.144C-25.9 29.078 4.648 45.352 4.648 45.352s7.786-9.827 6.882-37.644C9.347-32.96-5.078-50.929-5.078-50.929l-9.656-1.757z"
          />
          <ellipse
            cx={427.11}
            cy={905}
          ...
          <circle
            ...
            cx={198.98}
            cy={362.39}
            transform="matrix(.23597 -.01236 .01334 .24161 -73.6 -149.766)"
            r={4.71}
            stroke="none"
          />
        </g>
