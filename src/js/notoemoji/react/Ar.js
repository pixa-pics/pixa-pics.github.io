  ...
  return (
    ...
    >
      ...
      <g id="AR_svg__c">
        ...
        />
        <use xlinkHref="#AR_svg__a" transform="rotate(22.5 400 250)" />
        <use xlinkHref="#AR_svg__a" transform="rotate(45 400 250)" />
        <use xlinkHref="#AR_svg__a" transform="rotate(67.5 400 250)" />
        <path
          id="AR_svg__b"
          fill="#85340a"
        ...
        />
        <use xlinkHref="#AR_svg__b" transform="rotate(22.5 400 250)" />
        <use xlinkHref="#AR_svg__b" transform="rotate(45 400 250)" />
        <use xlinkHref="#AR_svg__b" transform="rotate(67.5 400 250)" />
      </g>
      ...
      />
      <use xlinkHref="#AR_svg__d" transform="matrix(-1 0 0 1 800.25 0)" />
      <use xlinkHref="#AR_svg__e" transform="matrix(-1 0 0 1 800.25 0)" />
      <use xlinkHref="#AR_svg__f" transform="translate(18.862)" />
      <use xlinkHref="#AR_svg__g" transform="matrix(-1 0 0 1 800.25 0)" />
      <path
      ...
      />
      <use xlinkHref="#AR_svg__h" transform="translate(-19.181)" />
      <circle id="AR_svg__f" cy={246.15} cx={390.54} r={1.923} fill="#85340a" />
      <path
        id="AR_svg__g"
        fill="#85340a"
