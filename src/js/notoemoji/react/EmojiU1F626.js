...
function SvgEmojiU1F626(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      <radialGradient
        id="emoji_u1f626_svg__a"
        cx={63.6}
        cy={1696.9}
        r={56.96}
      ...
      />
      <path
        d="M64 99.9c3.85 0 7.67.66 11.3 1.93 7.7 2.69 14.37-6 9.9-12.8C80.54 82 73.29 80 64 80s-16.53 1.91-21.19 9c-4.48 6.81 2.2 15.48 9.9 12.8 3.63-1.27 7.45-1.91 11.29-1.9zM44 49.94c-4.19 0-8 3.54-8 9.42s3.81 9.41 8 9.41c4.2 0 8-3.54 8-9.41s-3.76-9.42-8-9.42z"
        fill="#422b0d"
      />
      <path
