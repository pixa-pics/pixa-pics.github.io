...
function SvgEmojiU2199(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
      ...
      />
      <path
        d="M71.36 94.85H37.42a4.01 4.01 0 01-4.24-4.24V56.66c.21-3.46 4.38-4.95 6.79-2.55l9.9 9.9c.78.78 2.05.78 2.83 0l32.53-32.53a4.008 4.008 0 015.66 0l5.66 5.66a4.008 4.008 0 010 5.66L64.01 75.33c-.78.78-.78 2.05 0 2.83l9.9 9.9c2.4 2.4.92 6.58-2.55 6.79z"
        fill="#fafafa"
      />
      <path
