...
function SvgNp(props) {
  return (
    <svg
      ...
      {...props}
    >
      <use stroke="#003893" strokeWidth={5.165} xlinkHref="#NP_svg__a" />
      <path
        id="NP_svg__a"
        fill="#DC143C"
