    ...
    return (
        ...
        >
            ...
            <g clipPath="url(#prefix__a)">
                ...
                />
                <path
                    d="M510.553 311.584c-31.221 31.221-81.916 31.221-113.137 0-31.221-31.221-31.221-81.916 0-113.137M242.584 198.447c31.221 31.221 31.221 81.916 0 113.137-31.221 31.221-81.916 31.221-113.137 0"
                    fill="#FFF"
                />
            </g>
        </svg>
