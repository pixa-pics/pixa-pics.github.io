...
var Layer = function(image_data, width, height){
    ...
    if(typeof image_data.data != "undefined") { // image_data
        ...
        this.uint32_pixel_color_ = new Uint32Array(image_data.data.slice(0, image_data.data.length).reverse().buffer).reverse().buffer;
        this.width_ = image_data.width | 0;
        this.height_ = image_data.height | 0;

    }else if(typeof image_data.buffer != "undefined") { // image_data.data
        this.uint32_pixel_color_ = new Uint32Array(image_data.slice(0, image_data.length).reverse().buffer).reverse().buffer;
        this.width_ = width | 0;
    ...
    this.uint32_colors_ = Uint32Array.from(Array.from(new Set(this.uint32_pixel_color_)));
    ...
    for(var i = 0, l = this.color_indexes_length_ | 0; (i|0) < (l|0); i = i + 1 | 0) {
        this.color_indexes_[i|0] = this.uint32_colors_.indexOf(this.uint32_pixel_color_[i|0]) | 0;
    }
};
...
Object.defineProperty(Layer.prototype, 'force_update_data', {
    get: function() {
        ...
        return function (){
            "use strict";
            for(var i = 0, l = this.color_indexes_length_ | 0; (i|0) < (l|0); i = i + 1 | 0) {
                this.uint32_pixel_color_[i|0] = clamp_uint32(this.uint32_colors_[this.color_indexes_[i|0]|0]);
            }
        };
    },
    enumerable: false,
...
Object.defineProperty(Layer.prototype, 'data_uint8ca_copy', {
    get: function() {
        "use strict";
        return new Uint8ClampedArray(this.uint32_pixel_color_.slice(0, this.uint32_pixel_color_.length).reverse().buffer).reverse();
    },
    enumerable: false,
    configurable: false
});

Object.defineProperty(Layer.prototype, 'data_uint32', {
    get: function() {
        "use strict";
