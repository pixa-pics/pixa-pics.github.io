...
function hqnx(image_data, scale, pool) {
    ...
    return new Promise(function(resolve, reject){
        ...
        if(Boolean(pool)) {
            ...
            pool.exec(hqnx_process_function, [
                image_data,
                scale,
            ]).catch((e) => {

                return hqnx_process_function(image_data, scale);
            }).then((result) => {
            ...
            hqnx_process_function(image_data, scale).then((result) => {
