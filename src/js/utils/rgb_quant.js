...
const rgb_quant = (imagedata, limit, callback_function = () => {}, pool = null) => {
    ...
    if(pool !== null) {
        ...
        pool.exec(window.rgb_quant_process_function, [
            imagedata, limit
        ]).catch((e) => {
        ...
        window.rgb_quant_process_function(imagedata, limit).then((r)=> {
